package de.fhg.fokus.streetlife.mmecp.client.view;
...
public class CSSDynamicData {
	...
	public static final int PopUpPanelContainer_HEIGHT = 30;
	
	// SlidebarLeft
	public final static int SlideBarLeft_WIDTH_ROLL_IN = 30;
	public final static int SlideBarLeft_WIDTH_ROLL_OUT = 230;

	// SlidebarRight
	public final static int SlideBarRight_WIDTH_ROLL_IN = 35;
	public final static int SlideBarRight_WIDTH_ROLL_OUT = 405;
	...
	//Charts
	public static int chartWidth = 370;
